  ...
  const programs = [
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="w-4 h-4"><path fill="currentColor" fill-rule="evenodd" d="M15.134 2.154a4.832 4.832 0 0 0-6.268 0 2.832 2.832 0 0 1-1.612.668 4.832 4.832 0 0 0-4.432 4.432 2.832 2.832 0 0 1-.668 1.612 4.832 4.832 0 0 0 0 6.268c.387.454.62 1.018.668 1.612a4.832 4.832 0 0 0 4.432 4.432 2.832 2.832 0 0 1 1.612.668 4.832 4.832 0 0 0 6.268 0 2.832 2.832 0 0 1 1.612-.668 4.832 4.832 0 0 0 4.432-4.432 2.832 2.832 0 0 1 .668-1.612 4.832 4.832 0 0 0 0-6.268 2.832 2.832 0 0 1-.668-1.612 4.832 4.832 0 0 0-4.432-4.432 2.832 2.832 0 0 1-1.612-.668Zm1.073 8.053a1 1 0 0 0-1.414-1.414L11 12.586l-1.293-1.293a1 1 0 0 0-1.414 1.414l2 2a1 1 0 0 0 1.414 0l4.5-4.5Z" clip-rule="evenodd"/></svg>`,
    ...
    },
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="w-4 h-4"><path fill="currentColor" d="M12 2a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1ZM4 19a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1Zm.607-13.807a1 1 0 1 0-1.414 1.414l1.414 1.414a1 1 0 1 0 1.414-1.414L4.607 5.193Zm16.2 0a1 1 0 0 1 0 1.414l-1.414 1.414a1 1 0 1 1-1.414-1.414l1.414-1.414a1 1 0 0 1 1.414 0ZM5.07 14a7.002 7.002 0 0 1 13.86 0H22a1 1 0 1 1 0 2H2a1 1 0 1 1 0-2h3.07Z"></path></svg>`,
      color: 'from-accent-500 to-accent-600'
    }
  ];
</script>
