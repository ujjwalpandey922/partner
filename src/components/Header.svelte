`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M1.263 16.5c0-3.567 2.829-6.5 6.369-6.5C11.172 10 14 12.933 14 16.5S11.171 23 7.632 23a6.246 6.246 0 0 1-2.083-.356 14.578 14.578 0 0 0-.224-.078l-.022-.007h-.005l-.168.023-2.995.409a1 1 0 0 1-1.111-1.207l.611-2.762a7.73 7.73 0 0 0 .041-.192 6.617 6.617 0 0 1-.413-2.33Z" clip-rule="evenodd"></path><path fill="currentColor" d="M5.148 8.373A8.3 8.3 0 0 1 7.618 8C12.33 8 16 11.89 16 16.5c0 .814-.114 1.605-.328 2.356a9.027 9.027 0 0 0 1.572-.431c.071-.027.142-.054.214-.079l.174.024 3.212.471c.152.023.324.048.474.056.166.01.425.009.698-.109a1.5 1.5 0 0 0 .772-.754c.123-.27.13-.529.125-.695a5.644 5.644 0 0 0-.045-.475l-.406-3.298a7.671 7.671 0 0 1-.02-.164c.018-.072.051-.142.078-.211A8.935 8.935 0 0 0 23.105 10c0-4.977-4.059-9-9.052-9-4.436 0-8.135 3.175-8.905 7.373Z"></path></svg>`,
              href: "#community"
            },
            {
              title: "Help Center",
              description: "Platform knowledge base and FAQs",
              icon:  `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11 11-4.925 11-11S18.075 1 12 1Zm1 7a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0V8Zm-1 7a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2H12Z" clip-rule="evenodd"></path></svg>`,
              href: "#help-center"
            },
            {
              title: "Office Hours",
...
<header  class="fixed top-0 left-0 right-0 z-50
                    ...
                    <div class="relative group">
                      ...
                      {#if item.hasDropdown && activeDropdown === item.name.toLowerCase()}
                       ...
                       {#if item.name === 'Platform'}
                              <div class="w-full h-auto max-h-[400px] relative">
                                <img
                                  src="/platform.png"
                                  alt="Platform"
                            ...
                            {:else if item.name === 'Solutions'}
                              <div class="w-full h-auto max-h-[300px] relative">
                                <img
                                  src="/sol.png"
                                  alt="Solutions"
                                  class="w-full h-auto object-contain"
                            ...
                            {:else if item.name === 'Resources'}
                              <div class="w-full h-auto max-h-[500px] relative">
                                <img
                                  src="/res.png"
                                  alt="Resources"
                                  class="w-full h-auto object-contain"
  ...
  <!-- Mobile Navigation --> 
      {#if isMenuOpen}
          <div class="fixed inset-0 top-16 bg-company-700 z-50 flex flex-col overflow-y-auto">
            {#if !activeMobileView}
              <!-- Initial Menu View -->
              <div class="px-6 py-8">
                <!-- Main Menu Items -->
